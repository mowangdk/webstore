		...
		$("#username").bind({
			focusout:function(){
				...
				if(username == null || username ==''){
					...
					$.get("findByName.action",{username:$("#username").val()},function(data){
						$("#span1").append(data);
					});
	...
	<div class="span5">
		<div class="logo">
			<a href="http://localhost:8080/mango/">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.gif" alt="gyq" />
			</a>
		</div>
	</div>
	<div class="span9">
		...
		<div class="topNav clearfix">
			<ul>
				<li id="headerLogin" class="headerLogin" style="display: list-item;">
					<a href="<c:url value='/getPage/getLogin.do' />">登录</a>|
				</li>
				<li id="headerRegister" class="headerRegister" style="display: list-item;">
					<a href="<c:url value='/getPage/getLogin.do' />">注册</a>|
				</li>
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${pageContext.request.contextPath}/user/regist.do" method="post">
						<table>
							<tbody><tr>
								<th>
							...
							<tr>
								...
								<td>
									<input type="text" id="email" name="email" id="email" class="text" maxlength="200" />
									<span id="span3"></span>
								</td>
							</tr>
									<tr>
										...
										<td>
												...
												<span id="span4"><s:fielderror fieldName="name"/></span>
										</td>
									</tr>
									<tr>
										<th>
										...
										<td>
												...
												<span id="span5"><s:fielderror fieldName="phone" /></span>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
												...
												<span id="span6"><s:fielderror fieldName="addr" /></span>
										</td>
									</tr>
							<tr>
								<th>&nbsp;
...
<div class="container footer">
	...
	<div class="span24">
		<div class="copyright">Copyright © 2015 网上商城 版权所有</div>
	</div>
</div>
